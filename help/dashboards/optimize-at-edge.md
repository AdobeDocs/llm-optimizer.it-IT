...
**Ottimizzazione BYOCDN Edge - Akamai**

Questa configurazione ha lo scopo di indirizzare le richieste degli agenti utente al servizio Edge Optimize (`live.edgeoptimize.net` backend). Per verificare la configurazione, al termine dell&#39;installazione cercare l&#39;intestazione `x-edgeoptimize-request-id` nella risposta.


**La regola JSON di Akamai Property Manager indirizza gli agenti utente LLM a Edge Optimize:**

La configurazione include i seguenti passaggi:

**1. Imposta criteri di routing (corrispondenza agente utente)**

![Imposta criteri di routing](/help/assets/optimize-at-edge/akamai-step1-routing.png)

**2. Imposta comportamento Origine e SSL**

![Imposta comportamento Origine e SSL](/help/assets/optimize-at-edge/akamai-step2-origin.png)

**3. Imposta variabile chiave cache**

![Imposta variabile chiave cache](/help/assets/optimize-at-edge/akamai-step3-cachekey.png)
...
![Modifica intestazioni richieste in ingresso](/help/assets/optimize-at-edge/akamai-step5-request.png)

**6. Modifica intestazioni risposta in ingresso**

![Modifica intestazioni risposta in ingresso](/help/assets/optimize-at-edge/akamai-step6-response.png)

**7. Modifica ID cache**

![Modifica ID cache](/help/assets/optimize-at-edge/akamai-step7-cacheid.png)

**8. Failover del sito**

![Failover del sito](/help/assets/optimize-at-edge/akamai-step8-failover.png)

![Comportamenti di failover](/help/assets/optimize-at-edge/akamai-step8-failover-behaviors.png)

![Regole di failover](/help/assets/optimize-at-edge/akamai-step8-failover-rules.png)

![Risposta comportamenti](/help/assets/optimize-at-edge/akamai-step8-behaviors-response.png)
