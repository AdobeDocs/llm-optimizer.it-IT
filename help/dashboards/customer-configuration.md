...
Dalla scheda Categorie è possibile definire le categorie commerciali o le linee di prodotti che si desidera monitorare e associarle a specifiche aree geografiche. Nel complesso, la scheda Categorie fa riferimento a tutte le altre personalizzazioni presenti in questa pagina, in quanto le categorie verranno visualizzate nel campo Categoria per le altre personalizzazioni (monitoraggio concorrente, alias e così via).Per aggiungere una nuova categoria:
