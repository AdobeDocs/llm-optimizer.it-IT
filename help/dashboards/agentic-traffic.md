...
LLM Optimizer elabora un sottoinsieme di campi dai registri CDN. Anche se i nomi dei campi di registro non elaborati variano a seconda del provider CDN, vengono normalizzati e presentati come:
